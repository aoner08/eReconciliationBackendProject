...
namespace Business.Concrete
{
	public class MailTemplateManager : IMailTemplateService
	{
		...
		[PerformanceAspect(3)]
		[SecuredOperation("MailTemplate.Add,Admin")] //tema ekleme yetki kontrolü
		...
		[PerformanceAspect(3)]//mevcut temayı mail gönderirken çağırdığımız için burda secured ile yetki vermedik
		[CacheAspect(60)]
